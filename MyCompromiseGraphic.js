...
const characterDataMaxima = [
 ...
 export default class MyCompromiseGraphicScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <VictoryChart polar
          ...
          <View style={{marginStart: 25, marginEnd: 25,marginTop: 30, justifyContent: 'flex-start'}}>
            ...
            <TouchableOpacity style={{width: 40, height: 40}}>
                <Icon style={{marginTop: 7, marginStart:5}} onPress={()=> this.props.navigation.navigate('MyCompromise')}  name="chevron-left" color="black" size={25} />
                </TouchableOpacity>
                <TouchableOpacity style={{width: 40, height: 40}}>
                <Icon  style={{marginTop: 7, marginStart: 20}} onPress={()=> this.props.navigation.navigate('MyChoices',{formdata:this.state.formdata}) }
                  name="chevron-right" color="black" size={25} /></TouchableOpacity>
            </View>
